...
namespace Vsar.TSBot.UnitTests
{
    ...
    public class ConnectDialogTests : TestsBase<DialogFixture>
    {
        ...
        {
            Assert.ThrowsException<ArgumentNullException>(() => new ConnectDialog(new Uri(AuthorizeUrl), null, null));
        ...
        {
            Assert.ThrowsException<ArgumentNullException>(() => new ConnectDialog(new Uri(AuthorizeUrl), this.Fixture.VstsService.Object, null));
        ...
        public async Task Start()
        {
            ...
            var mocked = new Mock<ConnectDialog>(new Uri(AuthorizeUrl), this.Fixture.VstsService.Object, this.Fixture.VstsApplicationRegistry.Object) { CallBase = true };
        ...
        {
            var target = new ConnectDialog(new Uri(AuthorizeUrl), this.Fixture.VstsService.Object, this.Fixture.VstsApplicationRegistry.Object);
        ...
        public async Task LogOn()
        {
            ...
            this.Fixture.VstsApplicationRegistry
                ...
                .Returns(new VstsApplication("id", "secret", "scope"));
        ...
        public async Task Handle_Received_Pin_Which_Is_Invalid()
        {
            ...
            var target = new ConnectDialog(new Uri(AuthorizeUrl), this.Fixture.VstsService.Object, this.Fixture.VstsApplicationRegistry.Object) { Pin = "12345" };
        ...
        public async Task Select_Account()
        {
            ...
            var target = new ConnectDialog(new Uri(AuthorizeUrl), this.Fixture.VstsService.Object, this.Fixture.VstsApplicationRegistry.Object) { Profiles = profiles };
        ...
        public async Task Select_Project()
        {
            ...
            var target = new ConnectDialog(new Uri(AuthorizeUrl), this.Fixture.VstsService.Object, this.Fixture.VstsApplicationRegistry.Object) { Account = account, Profile = profile };
